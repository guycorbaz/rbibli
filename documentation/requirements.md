...
> **Note**: This document describes functional requirements independent of implementation technology. The application is implemented with Slint UI (native, with WASM compilation planned) and a REST API backend (actix-web + MariaDB). See `architecture.md` and `planning.md` for current architecture.
...
- [x] Basic title and volume management
- [x] Simple loan tracking (who borrowed what, when)
- [x] Web interface with barcode scanner support
- [x] Basic search and browsing
- [x] Manual backup/restore (export/import)

### Phase 2

- [x] Author and series management
- [x] Multiple copies per title
- [x] Wishlist for titles without volumes
- [x] Basic statistics and reports
- [x] Volume condition tracking

### Phase 3

- [x] Optional Dewey classification (Manual entry)
- [x] Google Books integration for metadata
- [ ] Basic email notifications (optional)
- [x] Simple mobile-responsive interface (Slint adaptation)
- [x] Location management for physical organization

### Phase 4 (Optional Enhancements)

- [x] French/English interface toggle
- [x] Advanced search and filtering
- [ ] Simple sharing features for small groups
- [x] Enhanced import/export formats
