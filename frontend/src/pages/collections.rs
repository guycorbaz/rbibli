        ...
        <CollectionSideMenu/>
            <div class="p-6 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <p class="text-gray-600">"Liste des titres à venir..."</p>
                </div>
            </div>
        </div>
    }
...
#[component]
pub fn CollectionSideMenu() -> impl IntoView {
    let handle_new_title = move |_| {
        // Logique pour créer un nouveau titre
        log::info!("Nouveau titre cliqué");
    };

    let handle_new_serie = move |_| {
        // Logique pour créer une nouvelle série
        log::info!("Nouvelle série cliqué");
    };

    let handle_new_volume = move |_| {
        // Logique pour créer une nouvelle
        log::info!("Nouveau volume cliqué");
    };
    ...
    view! {
        <div class=" left-0 top-0 h-full bg-white border-r border-gray-200 shadow-lg z-40 w-64">
            ...
            <div class="p-4 space-y-2">
                // Bouton "Nouveau titre"
                <button
                    on:click=handle_new_title
                ...
                >
                    ...
                    <span class="text-sm font-medium">"Nouveau titre"</span>
                ...
                >
                    ...
                    <span class="text-sm font-medium">"Nouvelle série"</span>
                    <div class="flex-1"></div>
                ...
                // Bouton "Nouveau volume"
                <button
                    on:click=handle_new_volume
                    class="w-full flex items-center space-x-3 px-4 py-3 text-left rounded-md hover:bg-green-50 hover:text-green-700 transition-colors duration-200 group"
                >
                    <div class="flex-shrink-0">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium">"Nouveau volume"</span>
                    <div class="flex-1"></div>
                    <svg class="w-4 h-4 text-gray-300 group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
            ...
            <div class="border-t border-gray-200 mt-4 pt-4 p-4">
                ...
                <div class="space-y-2">
                    <a href="/collections" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                        "Tous les titres"
                    </a>
                    <a href="/collections/séries" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                        "Toutes les séries"
                    </a>
                </div>
            </div>
