...
pub fn LoansPage() -> impl IntoView {
    view! {
        ...
        <div class="p-6 space-y-6">
            <h1 class="text-2xl font-bold">"Prêts"</h1>
                <div class="bg-white rounded-lg shadow p-6">
                    <p class="text-gray-600">"Gestion des prêts à venir..."</p>
                </div>
            </div>
        </div>
    }
...
#[component]
pub fn LoanSideMenu() -> impl IntoView {
    let handle_new_subscriber = move |_| {
        // Logique pour créer un nouvel auteur
        log::info!("Nouvel abonné cliqué");
    };

    let handle_loan = move |_| {
        // Logique pour créer un prêt
        log::info!("Prêt cliqué");
    };

    let handle_return = move |_| {
        // Logique pour créer un retour
        log::info!("Retour cliqué");
    };
    ...
    view! {
        <div class=" left-0 top-0 h-full bg-white border-r border-gray-200 shadow-lg z-40 w-64">
            ...
            <div class="p-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">"Prêts"</h2>
            </div>
            ...
            <div class="p-4 space-y-2">
                ...
                <button
                    on:click=handle_new_subscriber
                ...
                >
                    ...
                    <span class="text-sm font-medium">"Nouvel abonné"</span>
                ...
                >
                    ...
                    <div class="flex-1"></div>
                    <svg class="w-4 h-4 text-gray-300 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
                </button>
            </div>
            ...
            <div class="border-t border-gray-200 mt-4 pt-4 p-4">
                ...
                <div class="space-y-2">
                    <a href="/loans" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                        "Prêts en cours"
                    </a>
                    <a href="/loans/subscriber" class="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                        "Abonnés"
                    </a>
                </div>
            </div>
